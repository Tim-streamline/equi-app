        ...
        <ScrollView contentContainerStyle={{ paddingBottom: padBottom }}>
          ...
          <View className="px-5 pb-3">
            <View className="flex-row items-center gap-2.5 rounded-xl border border-ink-8 bg-white px-3.5 py-2.5">
              ...
              <TextInput
                placeholder="Zoek in 240+ artikelen, video's, kruiden"
          ...
          <View className="px-4 gap-2">
            {LIBRARY_LIST.map((a) => (
              <Pressable
                key={a.id}
                onPress={() => router.push({ pathname: '/(tabs)/library/article/[id]', params: { id: a.id } } as any)}
              ...
              >
                ...
                <View className="flex-1 justify-center">
                  ...
                  <Text className="mt-0.5 text-[11px] text-ink-50">{a.dur}</Text>
                </View>
              </Pressable>
            ))}
          </View>
