...
export type RepeaterSub = {
  id: string;
  label: string;
  type: 'text' | 'number' | 'textarea' | 'date' | 'radio';
  /** Smaller helper line under the sub-field label. */
  hint?: string;
  /** Options for a `radio` sub-field (rendered as a compact chip row). */
  options?: string[];
};
...
export type Field = {
  ...
  tall?: boolean;
  /**
   * For a `text` field: render this many stacked single-line inputs instead of
   * one (e.g. "omschrijf het karakter in 3 woorden" → 3 boxes). The value is
   * stored as a string array, one entry per box.
   */
  lines?: number;
...
export const INTAKE_SCHEMA: Section[] = [
  /* ============= 00 · CONTACT & OPENHEID ============= */
  {
    ...
    fields: [
      ...
      {
        id: 'naam-eigenaar',
        label: 'Wat is jouw voor- en achternaam?',
        type: 'text',
        required: true,
      },
      {
        id: 'socials',
        label: 'Hoe kunnen we met je connecten via de socials (Instagram/FB/TikTok)?',
        type: 'text',
        required: true,
        hint: "Vul je gebruikersnaam(en) in, of 'n.v.t.' als je deze niet hebt.",
      },
      {
        id: 'hoe-gevonden',
  ...
  /* ============= 01 · OVER JE PAARD ============= */
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Hoe vaak is jouw paard verhuisd sinds hij/zij bij jou is?',
        type: 'radio',
        required: true,
        options: ['Niet verhuisd', '1 keer', '2-3 keer', '4-5 keer', 'Meer dan 5 keer'],
      },
      {
        id: 'verhuizingen-redenen',
        label: 'Wat waren de belangrijkste redenen voor deze verhuizingen?',
        type: 'multi',
        hint: 'Klik alles aan wat relevant is.',
        options: [
          'Verhuizing eigenaar',
          'Betere huisvesting gezocht',
          'Problemen op vorige stal',
          'Medische redenen',
          'Sociale problemen in de groep',
          'Weide-/voerbeleid',
          'Trainingsdoeleinden',
          'Pensionstal stopte',
          'Anders, namelijk',
        ],
        showIf: { 'aantal-verhuizingen': ['1 keer', '2-3 keer', '4-5 keer', 'Meer dan 5 keer'] },
      },
      {
        id: 'verhuizingen-redenen-anders',
        label: 'Anders, namelijk',
        type: 'text',
        showIf: { 'verhuizingen-redenen': 'Anders, namelijk' },
      },
      {
        id: 'conditie',
      ...
      {
        id: 'paard-leuk',
        label: 'Vertel iets over wat je paard heel erg leuk vindt om te doen.',
        type: 'textarea',
        required: true,
      },
    ],
  ...
  /* ============= 02 · KLACHT & HULPVRAAG ============= */
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Indien je iets hebt aangevinkt, licht dit kort toe.',
        type: 'textarea',
        optional: true,
        showIf: { acuut: 'any-checked' },
      },
      {
        id: 'thema',
        label: "Welke thema's spelen op dit moment een rol?",
        type: 'multi',
        optional: true,
        options: [
          'Jeuk',
  ...
  /* ============= 03 · GESCHIEDENIS ============= */
  {
    id: 'geschiedenis',
    nr: 3,
    title: '(Medische) geschiedenis van je paard',
    intro:
      'Vragen over de achtergrond, levensloop en belangrijke (medische) gebeurtenissen in het leven van jouw paard.',
    minutes: 5,
    icon: 'history',
    ...
    fields: [
      ...
      {
        id: 'moeder-metabolisch-anders',
        label: 'Anders, namelijk',
        type: 'text',
        showIf: { 'moeder-metabolisch': 'Anders, namelijk' },
      },
      {
        id: 'spenen-inrijden-huis',
        label: 'Hoe woonde je paard tussen het spenen en het inrijden?',
        type: 'textarea',
      ...
      /* ----- Vruchtbaarheid / voortplanting · MERRIE ----- */
      {
        id: 'sec-merrie-vruchtbaarheid',
        label: 'Vruchtbaarheid en voortplanting',
        type: 'sectionhead',
        showIf: { 'paard.geslacht': 'merrie' },
      },
      {
        id: 'merrie-vruchtbaarheid',
        ...
        flagIf: ['Ja, momenteel', 'Ja, in het verleden', 'Vermoeden / verhoogd risico'],
        showIf: { 'paard.geslacht': 'merrie' },
      },
      {
        id: 'merrie-vruchtbaarheid-waar',
        label: 'Indien ja, waar ging het om?',
        type: 'multi',
        hint: 'Klik alles aan wat relevant is.',
        options: [
          'Moeilijk drachtig worden',
          'Niet drachtig geworden ondanks meerdere pogingen',
          'Vroeg embryonaal verlies',
          'Verwerpen / abortus',
          'Tweelingdracht',
          'Moeilijke bevalling',
          'Placenta niet losgekomen',
          'Baarmoederontsteking',
          'Cystes',
          'Onregelmatige cyclus',
          'Opvallend hengstig gedrag',
          'Pijn tijdens hengstigheid',
          'Verminderde vruchtbaarheid zonder duidelijke oorzaak',
          'Probleem bij hengst',
          'Anders, namelijk',
        ],
        showIf: {
          'paard.geslacht': 'merrie',
          'merrie-vruchtbaarheid': ['Ja, momenteel', 'Ja, in het verleden'],
        },
      },
      {
        id: 'merrie-vruchtbaarheid-waar-anders',
        label: 'Anders, namelijk',
        type: 'text',
        showIf: { 'merrie-vruchtbaarheid-waar': 'Anders, namelijk' },
      },
      {
        id: 'merrie-vruchtbaarheid-wanneer',
      ...
      {
        id: 'merrie-vruchtbaarheid-da',
        label: 'Is hiervoor een dierenarts betrokken geweest?',
        type: 'radio',
      ...
      {
        id: 'merrie-vruchtbaarheid-diagnose',
        label: 'Is er een diagnose gesteld?',
        type: 'textarea',
        showIf: {
          'paard.geslacht': 'merrie',
          'merrie-vruchtbaarheid': ['Ja, momenteel', 'Ja, in het verleden'],
      ...
      {
        id: 'merrie-vruchtbaarheid-behandeling',
      ...
      {
        id: 'merrie-vruchtbaarheid-verdwenen',
        label: 'Is het probleem volledig verdwenen?',
        type: 'radio',
        options: ['Ja', 'Nee', 'Komt terug', 'Weet ik niet'],
        showIf: {
          'paard.geslacht': 'merrie',
          'merrie-vruchtbaarheid': ['Ja, momenteel', 'Ja, in het verleden'],
        },
      ...
      {
        id: 'merrie-vruchtbaarheid-toelichting',
      ...
      /* ----- Vruchtbaarheid / voortplanting · HENGST ----- */
      {
        id: 'sec-hengst-vruchtbaarheid',
        label: 'Vruchtbaarheid en voortplanting',
        type: 'sectionhead',
        showIf: { 'paard.geslacht': 'hengst' },
      },
      {
        id: 'hengst-vruchtbaarheid',
        label: 'Zijn er ooit vruchtbaarheids- of voortplantingsproblemen geweest?',
        type: 'radio',
        required: true,
        options: [
      ...
      },
      {
        ...
        options: [
          ...
          'Lage beweeglijkheid van sperma',
          'Problemen met dekken',
          'Problemen met sperma-afname',
          'Problemen met libido / hengstigheidsgedrag',
          'Testikelproblemen',
          'Penisproblemen',
          'Infectie van voortplantingsorganen',
          'Niet-ingedaalde testikel',
          'Dekte merries moeilijk drachtig',
          'Verminderde vruchtbaarheid zonder duidelijke oorzaak',
          'Anders, namelijk',
        ],
        showIf: {
          'paard.geslacht': 'hengst',
          'hengst-vruchtbaarheid': ['Ja, momenteel', 'Ja, in het verleden'],
        },
      },
      {
        id: 'hengst-vruchtbaarheid-waar-anders',
        label: 'Anders, namelijk',
        type: 'text',
        showIf: { 'hengst-vruchtbaarheid-waar': 'Anders, namelijk' },
      },
      {
        id: 'hengst-vruchtbaarheid-wanneer',
        label: 'Wanneer speelde dit?',
        type: 'radio',
        options: [
          'Speelt momenteel',
      ...
      {
        id: 'hengst-vruchtbaarheid-diagnose',
        label: 'Is er een diagnose gesteld?',
        type: 'textarea',
        showIf: {
          'paard.geslacht': 'hengst',
      ...
      {
        id: 'hengst-vruchtbaarheid-behandeling',
        label: 'Welke behandeling(en) zijn ingezet?',
        type: 'textarea',
        showIf: {
          'paard.geslacht': 'hengst',
      ...
      {
        id: 'hengst-vruchtbaarheid-verdwenen',
        label: 'Is het probleem volledig verdwenen?',
        type: 'radio',
        options: ['Ja', 'Nee', 'Komt terug', 'Weet ik niet'],
        showIf: {
      ...
      {
        id: 'hengst-vruchtbaarheid-toelichting',
        label: 'Eventuele toelichting',
        type: 'textarea',
        optional: true,
        showIf: {
      ...
      /* ----- Penis & koker · RUIN en HENGST ----- */
      {
        id: 'sec-penis-koker',
        label: 'Penis en koker',
        type: 'sectionhead',
        showIf: { 'paard.geslacht': ['ruin', 'hengst'] },
      },
      {
        id: 'penis-koker-controle',
        label:
          'Zijn de penis en koker van jouw paard de afgelopen 2 jaar gecontroleerd of gereinigd?',
        type: 'radio',
        required: true,
        options: ['Ja', 'Nee', 'Weet ik niet'],
        showIf: { 'paard.geslacht': ['ruin', 'hengst'] },
      ...
      {
        id: 'penis-koker-bevindingen',
        label: 'Indien ja, zijn er bijzonderheden gevonden?',
        type: 'multi',
        hint: 'Klik alles aan wat relevant is.',
        options: [
          'Geen bijzonderheden',
          'Smegma-opbouw',
          'Smegmaboon verwijderd',
          'Irritatie of ontsteking',
          'Zwelling',
          'Gevoeligheid bij aanraken',
          'Moeite met uit- of intrekken van de penis',
          'Anders, namelijk',
        ],
        flagIf: 'any',
        showIf: { 'paard.geslacht': ['ruin', 'hengst'], 'penis-koker-controle': 'Ja' },
      },
      {
        id: 'penis-koker-bevindingen-anders',
        label: 'Anders, namelijk',
        type: 'text',
        showIf: { 'penis-koker-bevindingen': 'Anders, namelijk' },
      },
      {
        id: 'penis-koker-wanneer',
        label: 'Wanneer was de laatste controle of reiniging ongeveer?',
        type: 'text',
        showIf: { 'paard.geslacht': ['ruin', 'hengst'], 'penis-koker-controle': 'Ja' },
      },

      /* ----- Overige medische gebeurtenissen ----- */
      {
        id: 'sec-medische-gebeurtenissen',
        label: 'Overige medische gebeurtenissen',
        type: 'sectionhead',
      },
      {
  ...
  /* ============= 04 · MEDISCH & SPECIALISTEN ============= */
  {
    ...
    intro:
      'Vragen over de huidige gezondheid van jouw paard, preventieve zorg en betrokken professionals.',
    minutes: 6,
    icon: 'heart',
    ...
    fields: [
      ...
      {
        id: 'hoefverzorger-type',
        label: 'Wat voor type hoefverzorger bekapt jouw paard meestal?',
        type: 'radio',
        required: true,
        options: [
          'Traditionele hoefsmid',
          'Natuurlijke bekapper',
          'Hoefspecialist',
          'Anders, namelijk',
        ],
      },
      {
        id: 'hoefverzorger-type-anders',
        label: 'Anders, namelijk',
        type: 'text',
        showIf: { 'hoefverzorger-type': 'Anders, namelijk' },
      },
      {
        id: 'hoeven-bijz',
        label: 'Zijn er bijzonderheden m.b.t. de voeten van je paard?',
        type: 'multi',
        required: true,
        options: [
      ...
      {
        id: 'hoefbevangenheid-eerste',
        label: 'Wanneer was de eerste episode van hoefbevangenheid?',
        type: 'text',
        showIf: { hoefbevangenheid: ['nu acuut', 'in verleden gehad', 'risico / vermoeden'] },
      },
      {
        id: 'hoefbevangenheid-recent',
        label: 'Wanneer was de meest recente episode van hoefbevangenheid?',
        type: 'text',
        showIf: { hoefbevangenheid: ['nu acuut', 'in verleden gehad', 'risico / vermoeden'] },
      },
      {
        id: 'hoefbevangenheid-aantal',
        label: 'Hoeveel episodes van hoefbevangenheid heeft jouw paard ongeveer gehad?',
        type: 'radio',
        options: ['1', '2-3', '4-5', 'Meer dan 5', 'Weet ik niet'],
        showIf: { hoefbevangenheid: ['nu acuut', 'in verleden gehad', 'risico / vermoeden'] },
      },
      {
        id: 'hoefbevangenheid-rontgen',
        label: "Zijn er röntgenfoto's gemaakt?",
        type: 'radio',
        options: ['Ja', 'Nee', 'Weet ik niet'],
        showIf: { hoefbevangenheid: ['nu acuut', 'in verleden gehad', 'risico / vermoeden'] },
      },
      {
        id: 'hoefbevangenheid-rontgen-upload',
        label: 'Upload de röntgenfoto’s hier',
        type: 'photo',
        optional: true,
        hint: "Tot 12 foto's mogelijk.",
        showIf: { 'hoefbevangenheid-rontgen': 'Ja' },
      },
      {
        id: 'hoefbevangenheid-bevindingen',
        label: 'Is er volgens de dierenarts of op de röntgenfoto sprake van één of meer van onderstaande?',
        type: 'multi',
        hint: 'Klik alles aan wat relevant is.',
        options: [
          'Kanteling / rotatie van het hoefbeen',
          'Zinking van het hoefbeen',
          'Verbreding van de witte lijn',
          'Verlies van zooldikte',
          'Misvormde hoefcapsule',
          'Weet ik niet',
        ],
        flagIf: [
          'Kanteling / rotatie van het hoefbeen',
      ...
      {
        id: 'hoefbevangenheid-gevolgen',
        label: 'Merk je momenteel nog gevolgen van de hoefbevangenheid?',
        type: 'multi',
        hint: 'Klik alles aan wat relevant is.',
        options: [
          'Geen merkbare gevolgen meer',
          'Gevoelig op harde ondergrond',
          'Gevoelig op steen of grind',
          'Regelmatig warme hoeven',
          'Sterke digitale pols',
          'Loopt korter dan vroeger',
          'Moeite met draaien',
          'Regelmatig stijf uit beweging komen',
          'Veranderingen in hoefvorm of hoefgroei',
          'Heeft aangepaste bekapping of hoefondersteuning nodig',
          'Anders, namelijk',
        ],
        flagIf: 'any',
        showIf: { hoefbevangenheid: ['nu acuut', 'in verleden gehad', 'risico / vermoeden'] },
      ...
      {
        id: 'hoefbevangenheid-gevolgen-anders',
        label: 'Anders, namelijk',
        type: 'text',
        showIf: { 'hoefbevangenheid-gevolgen': 'Anders, namelijk' },
      },
  ...
  /* ============= 05 · VOER & RUWVOER ============= */
  {
    ...
    fields: [
      ...
      {
        id: 'analyse-overig',
        label: 'Eventuele overige waarden',
        type: 'textarea',
        optional: true,
        showIf: { 'ruwvoer-geanalyseerd': 'Ja' },
      },
      ...
      {
        id: 'hooi-kg-per-dag',
        label: 'Hoeveel kilo ruwvoer krijgt jouw paard gemiddeld per dag?',
        type: 'number',
        unit: 'kg',
        required: true,
        hint:
          'Probeer indien mogelijk te wegen. Gokken levert vrijwel altijd een vertekend beeld op. Weet je het niet precies, vul dan een schatting in.',
      },
      {
        id: 'hooi-kg-methode',
        label: 'Hoe heb je dit bepaald?',
        type: 'radio',
        required: true,
        options: ['Gewogen in de afgelopen maand', 'Ooit gewogen, momenteel geschat', 'Geschat'],
        flagIf: ['Ooit gewogen, momenteel geschat', 'Geschat'],
      },
      {
        id: 'foto-hooi',
      ...
      { id: 'sec-voordroog', label: 'Voordroog en kuil', type: 'sectionhead' },
      {
        ...
        label: 'Heeft jouw paard ooit ruwvoer gekregen dat in plastic verpakt was?',
        type: 'radio',
        required: true,
        options: [
          'Nee',
      ...
      },
      {
        ...
        label: 'In welke periode kreeg jouw paard dit ongeveer?',
        type: 'text',
        showIf: {
          'voordroog-verleden': [
            'Ja, incidenteel of kortdurend',
      ...
      },
      {
        ...
        label: 'Licht de voerwissel toe.',
        type: 'textarea',
        hint: 'Wat kreeg je paard eerst, waar ben je naar overgestapt en wanneer vond deze verandering plaats?',
        showIf: {
          'voer-gewisseld': [
            'Ja, in de afgelopen 2 weken',
            'Ja, in de afgelopen maand',
      ...
      {
        id: 'snacks-aanwezig',
        label: "Krijgt jouw paard snacks, tussendoortjes of extra's buiten het normale rantsoen om?",
        type: 'radio',
        required: true,
      ...
      {
        id: 'snacks-details',
        label: "Welke snacks of extra's krijgt jouw paard?",
        type: 'repeater',
        hint:
          'Denk aan paardensnoepjes, wortels, appels, fruit, brood, likemmers, kruiden, takken, losse brokjes, etc.',
        showIf: { 'snacks-aanwezig': 'Ja' },
        flagIf: 'any',
        sub: [
          { id: 'wat', label: 'Wat krijgt jouw paard?', type: 'text' },
          { id: 'merk', label: 'Merk + productnaam (indien van toepassing)', type: 'text' },
          { id: 'hoeveel', label: 'Hoeveel krijgt jouw paard hiervan ongeveer?', type: 'text' },
          {
            id: 'hoevaak',
            label: 'Hoe vaak krijgt jouw paard dit?',
            type: 'radio',
            options: [
              'Dagelijks',
          ...
          { id: 'sinds', label: 'Sinds wanneer krijgt jouw paard dit ongeveer?', type: 'text' },
          {
            id: 'waarom',
            label: 'Waarom geef je dit?',
            type: 'radio',
            options: [
              'Beloning',
              'Training',
              ...
              'Omdat mijn paard het lekker vindt',
              'Anders, namelijk',
            ],
          },
          { id: 'waarom-anders', label: 'Anders, namelijk (waarom)', type: 'text' },
        ],
      },
      {
        id: 'huidig-extra',
  ...
  /* ============= 06 · WATER & UITSCHEIDING ============= */
  {
    ...
    intro: 'Vragen over drinkgedrag, waterkwaliteit, de mest en urine van jouw paard.',
    minutes: 5,
    icon: 'droplet',
    ...
    fields: [
      {
        id: 'water-type',
        label: 'Wat voor water drinkt jouw paard?',
        type: 'multi',
        required: true,
        hint: 'Klik alles aan wat van toepassing is.',
        options: [
          ...
          'Sloot-, beek- of vijverwater',
          'Opgeslagen water (tank, opvangvat, reservoir, etc.)',
          'Weet ik niet',
          'Anders, namelijk',
        ],
        flagIf: ['Sloot-, beek- of vijverwater', 'Weet ik niet'],
      },
      {
        id: 'water-type-anders',
        label: 'Anders, namelijk',
        type: 'text',
        showIf: { 'water-type': 'Anders, namelijk' },
      },
      {
        id: 'water-type-verdeling',
        label: 'Licht kort toe hoe dit verdeeld is.',
        type: 'textarea',
        hint:
          'Bijvoorbeeld: in de winter leidingwater, in de zomer grondwater. Of: paddock = leidingwater, weide = slootwater.',
        showIf: { 'water-type': 'multi-checked' },
      },
      {
        id: 'water-aanbod',
        ...
        options: [
          ...
          'Grote bak / kuip / ton',
          'Drinkbak in de stal',
          'Drinkbak buiten (paddock / track)',
          'Drinkbak in de weide',
      ...
      {
        id: 'water-aanbod-verdeling',
        label: 'Licht kort toe hoe dit verdeeld is.',
        type: 'textarea',
        hint: 'Bijvoorbeeld: stal = automatische drinkbak, paddock = kuip, weide = sloot.',
        showIf: { 'water-aanbod': 'multi-checked' },
      },
      {
        id: 'water-aanbod-liefst',
        label: 'Waar drinkt jouw paard het liefst uit?',
        type: 'text',
        showIf: { 'water-aanbod': 'multi-checked' },
      },
      {
        id: 'water-analyse',
        label: 'Is er een wateranalyse beschikbaar?',
        type: 'radio',
        required: true,
        options: ['Ja', 'Nee', 'Weet ik niet'],
      },
      {
        id: 'water-analyse-upload',
        label: 'Upload de wateranalyse hier',
        type: 'file',
        optional: true,
        hint: 'Upload PDF.',
        showIf: { 'water-analyse': 'Ja' },
      },
      {
        id: 'water-toegang',
      ...
      { id: 'sec-uit', label: 'Urine en mest', type: 'sectionhead' },
      {
        ...
        flagIf: ['oranje', 'troebel', 'Minder dan gemiddeld', 'Meer dan gemiddeld'],
      },
      {
        id: 'mest-freq',
      ...
      },
      {
        ...
        type: 'multi',
        options: ['groen', 'bruingroen', 'bruin', 'donkerbruin', 'zwart', 'weet ik niet'],
        flagIf: ['zwart'],
      },
      {
        id: 'mest-vorm',
  ...
  /* ============= 07 · HUISVESTING & WEIDEGANG ============= */
  {
    ...
    fields: [
      ...
      { id: 'sec-landbouw', label: 'Omgeving & landbouwpercelen', type: 'sectionhead' },
      {
        id: 'landbouw-nabij',
        label: 'Staat of graast je paard in de buurt van landbouwgrond, een boomgaard of wijngaard?',
        type: 'radio',
        required: true,
        options: ['Nee', 'Ja', 'Weet ik niet'],
      },
      {
        id: 'landbouw-afstand',
        label: 'Indien ja: hoe dichtbij ligt het dichtstbijzijnde perceel?',
        type: 'radio',
        required: true,
        showIf: { 'landbouw-nabij': 'Ja' },
        options: ['Direct grenzend aan paddock/weide', 'Minder dan 50 meter', '50–200 meter', 'Meer dan 200 meter', 'Weet ik niet'],
      },
      {
        id: 'landbouw-gewas',
        label: 'Weet je wat er op dit perceel wordt verbouwd?',
        type: 'text',
        required: true,
        showIf: { 'landbouw-nabij': 'Ja' },
        hint: 'Bijvoorbeeld graan, maïs, zonnebloem, koolzaad, fruit, druiven, groente, onbekend.',
      },
      {
        id: 'landbouw-bespoten',
        label: 'Weet je of het perceel wordt bespoten of behandeld met gewasbeschermingsmiddelen?',
        type: 'radio',
        required: true,
        showIf: { 'landbouw-nabij': 'Ja' },
        options: ['Ja', 'Nee', 'Weet ik niet'],
      ...
      {
        id: 'landbouw-middelen',
        label: 'Weet je waarmee of waarvoor wordt gespoten?',
        type: 'multi',
        required: true,
        showIf: { 'landbouw-nabij': 'Ja', 'landbouw-bespoten': 'Ja' },
        hint: 'Meerdere antwoorden mogelijk.',
        options: ['Onkruidbestrijding / herbicide', 'Insectenbestrijding / insecticide', 'Schimmelbestrijding / fungicide', 'Anders', 'Weet ik niet'],
      },
      {
        id: 'landbouw-frequentie',
        label: 'Hoe vaak gebeurt dit ongeveer?',
        type: 'radio',
        required: true,
        showIf: { 'landbouw-nabij': 'Ja', 'landbouw-bespoten': 'Ja' },
        options: ['Enkele keren per jaar', 'Regelmatig tijdens het groeiseizoen', 'Heel frequent', 'Weet ik niet'],
      },
      {
        id: 'landbouw-nevel',
        label: 'Kan nevel of afspoeling volgens jou het terrein van je paard bereiken?',
        type: 'radio',
        required: true,
        showIf: { 'landbouw-nabij': 'Ja' },
        options: ['Ja, bij wind kan het richting paddock/weide waaien', 'Ja, regenwater kan vanaf het perceel richting paarden lopen', 'Beide', 'Waarschijnlijk niet', 'Weet ik niet'],
      },
      {
        id: 'landbouw-water',
        label: 'Komt drinkwater, slootwater of grondwater mogelijk uit hetzelfde gebied als deze landbouwpercelen?',
        type: 'radio',
        required: true,
        showIf: { 'landbouw-nabij': 'Ja' },
        options: ['Nee', 'Ja', 'Weet ik niet'],
      ...
      {
        id: 'landbouw-klachten',
        label: 'Heb je ooit gemerkt dat klachten kort na werkzaamheden op het land verergeren?',
        type: 'radio',
        required: true,
        showIf: { 'landbouw-nabij': 'Ja' },
        hint: 'Bijvoorbeeld huidreacties, luchtwegklachten, oogirritatie, mestveranderingen of opvallende onrust.',
        options: ['Nee', 'Ja', 'Weet ik niet'],
      },
      {
        id: 'landbouw-klachten-toelichting',
        label: 'Licht kort toe welke klachten je hebt gemerkt.',
        type: 'text',
        required: true,
        showIf: { 'landbouw-nabij': 'Ja', 'landbouw-klachten': 'Ja' },
      },
      {
        id: 'omgeving-overig',
        label: 'Is er nog iets relevants over de omgeving van de paarden?',
        type: 'textarea',
        optional: true,
        hint: 'Denk bijvoorbeeld aan intensieve landbouw, kassen, boomgaard of wijngaard, mestopslag, compostering, industrie, een drukke weg, regelmatige verbranding of andere opvallende omgevingsfactoren?',
      },
    ],
  },
