...
export type Field = {
  ...
  step?: number;
  options?: string[];
  /** Slider end-label pair, e.g. ['waterig', 'droog/hard']. */
...
export const INTAKE_SCHEMA: Section[] = [
  ...
  /* ============= 03 · GESCHIEDENIS ============= */
  {
    ...
    intro:
      'Hoe je paard groot is geworden — vaak verstopte oorzaken zitten hier.',
    minutes: 5,
    icon: 'history',
    sub: 'Moeder, eerste maanden, medisch verleden',
    fields: [
      {
        id: 'moeder-voer-huis',
  ...
  /* ============= 04 · MEDISCH & SPECIALISTEN ============= */
  {
    ...
    minutes: 6,
    icon: 'heart',
    sub: 'Vaccinaties, gebit, hoeven, IR/EMS/KPU',
    fields: [
  ...
  /* ============= 05 · VOER & RUWVOER ============= */
  {
    ...
    fields: [
      ...
      {
        id: 'hooi-kg-per-dag',
        label: 'Hoeveel kg ruwvoer per dag?',
        type: 'number',
        unit: 'kg',
        required: true,
      },
