    ...
    <div className="phone" data-screen-label="03 Klant · Sectie invullen">
      ...
      <div className="screen">
        ...
        <div className="body" style={{ padding: '14px 20px 110px' }}>
          ...
          {/* Kwaliteit, duidelijke keuze ipv schuifbalk */}
            ...
            map((o) => {
              ...
              return (
                <button key={o.id} className="bigchip" style={{ padding: '12px 14px', borderColor: active ? 'var(--app-accent)' : 'var(--app-border)', background: active ? 'var(--app-accent-soft)' : 'white' }}>
                  <div style={{ width: 20, height: 20, borderRadius: '50%', border: '2px solid', borderColor: active ? 'var(--app-accent)' : 'var(--app-border)', background: active ? 'var(--app-accent)' : 'white', display: 'grid', placeItems: 'center', flexShrink: 0 }}>
                    {active && <span style={{ width: 8, height: 8, borderRadius: '50%', background: 'white' }}></span>}
                  </div>
