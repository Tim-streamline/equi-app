...
function ScreenLibrary({ go }) {
  return (
    <div className="screen with-tabs" data-screen-label="13 Library">
      <div className="body">
        <AppHeader greet="Bibliotheek" title="Bibliotheek" avatar="M" />
    ...
    <div className="screen" data-screen-label="14 Library article">
      ...
      <div className="body" style={{ padding: '0 20px 100px' }}>
        ...
        <p style={{ fontSize: 16, lineHeight: 1.65, color: 'var(--app-ink)', marginBottom: 14 }}>
          Brandnetel is in <em>mei en juni</em> op zijn krachtigst. De jonge blaadjes bevatten silicium, ijzer en een mild ontstekingsremmende werking, perfect bij voorjaarsjeuk.
        </p>
        ...
        <p style={{ fontSize: 15, lineHeight: 1.6, color: 'var(--app-ink-2)', marginBottom: 14 }}>
          Begin met <em>één eetlepel vers</em> per dag, los aangeboden ter vrije selectie. Geef elke dag een handje extra naar behoefte. Niet meer dan 4 handjes per dag.
        </p>
...
function ScreenCommunity({ go }) {
  return (
    <div className="screen with-tabs" data-screen-label="16 Community">
      <div className="body">
        <AppHeader greet="Community" title="Vraag & deel" avatar="M" />

        {/* Compose prompt */}
        <div style={{ padding: '0 16px 14px' }}>
          <button className="cmt-compose" onClick={() => go('community-thread')}>
            <div className="cmt-compose-av">M</div>
            <span className="cmt-compose-ph">Stel je vraag aan de community…</span>
            <span className="cmt-compose-ic">{I.plus}</span>
          </button>
        </div>
          ...
          <article key={t.id} className="cmt-card" onClick={() => go('community-thread')}>
              <div className="cmt-head">
                ...
                <div className="cmt-meta">
                  <div className="cmt-name">{t.name}</div>
                  <div className="cmt-sub">{t.when} · <span className="cmt-topic">{t.topic}</span></div>
                </div>
              </div>
            ...
            <div className="cmt-answer">
                  <div className="cmt-answer-by">
                    ...
                    <span className="cmt-verified">{I.check} reageerde</span>
                  </div>
              ...
              <div className="cmt-actions">
                ...
                <span className="cmt-act"><span className="ic">{I.reply}</span>{t.reactions.replies}</span>
  ...
  return (
    <div className="screen with-tabs" data-screen-label="18 Account">
      <div className="body">
        ...
        <div className="list" style={{ marginBottom: 18 }}>
          <div className="card" onClick={() => go('community')}>
            <div className="card-row">
              <div style={{ width: 44, height: 44, borderRadius: 12, background: 'var(--app-accent-soft)', display: 'grid', placeItems: 'center', color: 'var(--app-accent-strong)' }}>
                <span style={{ width: 22, height: 22 }}>{I.message}</span>
              </div>
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 15 }}>Community · Vraag &amp; deel</div>
                <div style={{ fontSize: 12, color: 'var(--app-ink-3)' }}>Stel je vraag, Shelley reageert mee</div>
              </div>
              <span style={{ color: 'var(--app-ink-3)' }}>{I.chevron}</span>
            </div>
          </div>
