<script>
    ...
    function emptyCategory() {
        ...
        return { label: '', slug: '', order: lastOrder + 1, is_default: false };
    }
    function create() {
        editing = null;
...
<AdminLayout title="Library-categorieën">
    ...
    <Card>
        <CardContent class="p-4">
            <Table>
                <TableHeader><TableRow><TableHead>Naam</TableHead><TableHead>Slug</TableHead><TableHead>Items</TableHead><TableHead>Standaard</TableHead><TableHead></TableHead></TableRow></TableHeader>
                <TableBody>
